    ...
    <div className="min-h-screen bg-slate-50 p-8 font-sans text-blue-900">
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-black tracking-tight">Rider List</h1>
            <p className="text-sm text-blue-700/60">Users with role: rider</p>
        ...
        <div className="overflow-hidden rounded-3xl border border-white bg-white shadow-2xl shadow-blue-100/40">
          ...
          {loading ? (
            <div className="p-8 text-sm font-semibold text-blue-500">Loading riders...</div>
          ) : error ? (
            <div className="p-8 text-sm font-semibold text-rose-500">{error}</div>
          ) : filteredItems.length === 0 ? (
            <div className="p-8 text-sm font-semibold text-blue-500">No riders found for this list.</div>
          ) : (
